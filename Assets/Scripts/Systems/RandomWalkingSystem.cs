...
partial struct RandomWalkingSystem : ISystem
{
    ...
    {
        foreach((RefRO<LocalTransform> localTransform, RefRW<RandomWalking> randomWalking, RefRW<UnitMover> unitMover) 
            in SystemAPI.Query<RefRO<LocalTransform>, RefRW<RandomWalking>, RefRW<UnitMover>>())
        {
